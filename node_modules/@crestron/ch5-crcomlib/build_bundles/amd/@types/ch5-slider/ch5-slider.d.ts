...
export declare class Ch5Slider extends Ch5CommonInput implements ICh5SliderAttributes {
    ...
    private _lastSliderStartTime;
    private static readonly SLIDER_INTERACTION_COOLDOWN;
    private _render;
    ...
    private _repeatDigitalOnClickInterval;
    private _sendEventOnClickPressed;
    private _sendEventOnClickGaugePressed;
    ...
    private _onSliderGaugeDown;
    private _onSliderGaugeUp;
    ...
    private _startSendEventOnClickRepeatDigital;
    private _stopSendEventOnClickRepeatDigital;
