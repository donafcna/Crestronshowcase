# Auditorium Richmond — recette 2.1.10
...
- Page Écran : les quatre sources exposent `pc_lectern`, `regie_hdmi`, `cam_feed` et `logo` avec un rendu distinct sur le mur LED 3D. HDMI régie affiche une présentatrice fictive du journal de 20 h ; Logo reprend l'asset officiel Fréquence TV. L'aperçu placé sous les boutons Smartphone est supprimé.
