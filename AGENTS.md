...
- Qualité 3D demandée : montagnes sans scintillement, habillage des pièces détaillé, stores/rideaux/volets visibles et animés là où ils ont du sens, luminosité selon les scènes ET la position des motorisations, ancienne demande de pièce noire en scène OFF lorsque toutes les occultations sont fermées (remplacée le 17/09 : toujours garder la coupe 3D lisible par un faible remplissage de présentation, tout en laissant les luminaires commandés à zéro), TV et écrans de source détaillés. Le compte rendu Claude annonce ce lot livré sous `571f7c76` ; ses choix de transmission lumineuse (15 % store, 30 % rideaux) sont des valeurs par défaut rapportées, pas une nouvelle validation explicite de Donatien.
