...
(async()=>{
 ...
 try{
  await page.goto(base+'/interfaces/residentiel/villa-gemini-frequencetv/phone');await page.waitForFunction(()=>window.__plan3d?.version==='2026-09-17-feedback-1'&&__plan3d.metrics().renderedFrames>0);
