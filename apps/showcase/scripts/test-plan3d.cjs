...
(async () => {
  ...
  try {
    await page.goto(base+route+'/phone');await require('./helpers/villa-manual.cjs').pauseVillaTour(page);
    await page.waitForFunction(() => window.__plan3d?.version === '2026-09-17-journey-1');
