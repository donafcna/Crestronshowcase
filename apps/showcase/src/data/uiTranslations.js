...
export const uiTranslations = {
  fr: {
    ...
    scale_caption_too_small: "réduit à {pct} % — fenêtre trop petite, agrandissez-la ou passez en Mode Scène",
  ...
  en: {
    ...
    scale_caption_too_small: "reduced to {pct}% — window too small, enlarge it or switch to Scene mode",
    scale_caption_size: "{w} × {h} px",
  ...
  de: {
    ...
    scale_caption_too_small: "verkleinert auf {pct} % — Fenster zu klein, vergrößern oder Szenenmodus wählen",
    scale_caption_size: "{w} × {h} px",
