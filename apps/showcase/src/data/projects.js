...
export const devices = [
  ...
  { id: `crestron`, name: `TSW-1070`, viewport: `wallpanel`, simulatorType: `wallpanel`, iconName: `LayoutGrid`,
    label: { fr: `Dalle TSW`, en: `TSW panel`, de: `TSW Panel` } },
...
export const projects = [
  ...
  {
    // NB : l'identifiant reste `crestron-home` pour ne pas casser les liens
    // déjà partagés (/interfaces/residentiel/crestron-home/...). Seul le nom
    // affiché change.
    id: `crestron-home`,
    name: `FTV Home`,
    status: `concept`,
    client: `Interface résidentielle Fréquence TV`,
    sectors: [`residentiel`],
    devices: [`ios_phone`, `ios_tablet`, `xpanel`, `crestron`],
    isInteractive: true,
    ...
    text: {
      fr: {
        description: `Interface résidentielle Fréquence TV : une même expérience du smartphone à la dalle murale.`,
        details: `FTV Home reprend les codes d'usage d'une application domotique moderne — accueil avec scènes et contrôles, navigation par pièces et par étage, détail de pièce par services — dans l'identité graphique Fréquence TV. La même interface est déclinée sur quatre supports : iPhone, iPad, dalle Crestron TSW-1070 et Xpanel. Éclairages gradables, occultants, thermostats multizones avec cadran et hygrométrie, accès sécurisés, distribution vidéo et audio multiroom.`,
        features: [
          `Un design, quatre supports : iPhone, iPad, TSW-1070, Xpanel`,
          `Éclairages gradables et scènes de vie`,
          `Occultants avec position au pourcentage`,
          `Thermostats multizones : cadran, mode, ventilation, hygrométrie`,
          `Vidéo multi-écrans et audio multiroom`,
          `Thème clair / sombre et personnalisation des contrôles affichés`,
        ],
      },
      en: {
        description: `Fréquence TV residential interface: one experience from smartphone to wall panel.`,
        details: `FTV Home follows the interaction patterns of a modern home-automation app — a home screen with scenes and controls, room navigation by floor, per-room service detail — rendered in the Fréquence TV visual identity. The same interface is delivered on four targets: iPhone, iPad, Crestron TSW-1070 wall panel and Xpanel. Dimmable lighting, shades, multi-zone thermostats with dial and humidity, secure access, video distribution and multiroom audio.`,
        features: [
          `One design, four targets: iPhone, iPad, TSW-1070, Xpanel`,
          `Dimmable lighting and lifestyle scenes`,
          `Shades with percentage positioning`,
          `Multi-zone thermostats: dial, mode, fan, humidity`,
          `Multi-display video and multiroom audio`,
          `Light / dark theme and configurable controls`,
        ],
      },
      de: {
        description: `Wohnraum-Oberfläche von Fréquence TV: ein Erlebnis vom Smartphone bis zum Wandpanel.`,
        details: `FTV Home übernimmt die Bedienmuster einer modernen Smart-Home-App — Startseite mit Szenen und Steuerungen, Navigation nach Räumen und Etagen, Raumdetail nach Diensten — im Erscheinungsbild von Fréquence TV. Dieselbe Oberfläche für vier Ziele: iPhone, iPad, Crestron TSW-1070 und Xpanel. Dimmbares Licht, Beschattung, Mehrzonen-Thermostate mit Skala und Feuchte, gesicherte Zugänge, Videoverteilung und Multiroom-Audio.`,
        features: [
          `Ein Design, vier Ziele: iPhone, iPad, TSW-1070, Xpanel`,
          `Dimmbares Licht und Lebensszenen`,
          `Beschattung mit prozentualer Position`,
          `Mehrzonen-Thermostate: Skala, Modus, Lüfter, Feuchte`,
          `Video auf mehreren Displays und Multiroom-Audio`,
          `Helles / dunkles Thema und konfigurierbare Steuerungen`,
        ],
      },
    },
  },
  ...
  // --- Trois interfaces « thèmes » issues du mood board (sept. 2026) ---------
  {
    id: `villa-leman`,
    name: `Villa Léman`,
    status: `concept`,
    client: `Villa au bord du Léman`,
    sectors: [`residentiel`],
    devices: [`crestron`, `ios_tablet`, `ios_phone`],
    isInteractive: true,
    interactiveComponent: `villa-leman`,
    thumbnailUrl: `https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=600&q=80`,
    year: `2026`,
    text: {
      fr: {
        description: `Villa de luxe à Cologny, thème « Obsidienne » : anthracite, un seul accent cyan, capitales condensées, cadrans circulaires et photos de pièces en fond.`,
        details: `Une villa au bord du Léman pilotée depuis une dalle TSW-1070 encastrée, l'iPad du salon et l'iPhone du propriétaire. L'accueil salue par un « Bonsoir » en grandes capitales, résume l'état de la maison en une phrase et propose quatre actions rapides (Bonjour, Soirée, Absent, Nuit). Les pièces s'affichent en tuiles photo par étage ; chaque pièce réunit éclairage, climat sur cadran circulaire, audio, stores et sécurité. Les pages Éclairage, Climat, Médias et Sécurité (clavier à code, serrures, caméras) complètent l'ensemble. Le rail d'icônes à gauche devient une barre d'onglets sur smartphone.`,
        features: [
          `Accueil en capitales condensées avec phrase d'état et actions rapides`,
          `Tuiles photo par étage : rez-de-chaussée, étage, extérieur`,
          `Cadran circulaire de climat avec consigne réglable`,
          `Éclairage global par pièce avec sliders et scènes`,
          `Médias : sources, transport, volume et zones audio`,
          `Sécurité : clavier à code, serrures, caméras`,
        ],
      },
      en: {
        description: `Luxury villa in Cologny, "Obsidian" theme: charcoal, a single cyan accent, condensed capitals, circular dials and room photos as backgrounds.`,
        details: `A villa on Lake Geneva controlled from a flush-mounted TSW-1070, the living-room iPad and the owner's iPhone. The home screen greets with a big condensed "Good evening", sums up the house in one sentence and offers four quick actions (Morning, Evening, Away, Night). Rooms appear as photo tiles per floor; each room gathers lighting, climate on a circular dial, audio, shades and security. Lighting, Climate, Media and Security pages (keypad, locks, cameras) complete the set. The left icon rail becomes a tab bar on the phone.`,
        features: [
          `Home screen in condensed capitals with status sentence and quick actions`,
          `Photo tiles per floor: ground floor, upstairs, outdoors`,
          `Circular climate dial with adjustable setpoint`,
          `Whole-house lighting per room with sliders and scenes`,
          `Media: sources, transport, volume and audio zones`,
          `Security: keypad, locks, cameras`,
        ],
      },
      de: {
        description: `Luxusvilla in Cologny, Thema «Obsidian»: Anthrazit, ein einziger Cyan-Akzent, schmale Versalien, runde Skalen und Raumfotos als Hintergrund.`,
        details: `Eine Villa am Genfersee, gesteuert über ein eingebautes TSW-1070, das iPad im Wohnzimmer und das iPhone des Eigentümers. Der Startbildschirm begrüsst mit einem grossen «Guten Abend», fasst den Zustand des Hauses in einem Satz zusammen und bietet vier Schnellaktionen (Morgen, Abend, Abwesend, Nacht). Die Räume erscheinen als Fotokacheln pro Etage; jeder Raum vereint Licht, Klima auf einer runden Skala, Audio, Storen und Sicherheit. Die Seiten Licht, Klima, Medien und Sicherheit (Codetastatur, Schlösser, Kameras) vervollständigen das Ganze. Die Icon-Leiste links wird auf dem Smartphone zur Tab-Leiste.`,
        features: [
          `Startbildschirm in schmalen Versalien mit Statussatz und Schnellaktionen`,
          `Fotokacheln pro Etage: Erdgeschoss, Obergeschoss, Aussen`,
          `Runde Klimaskala mit einstellbarem Sollwert`,
          `Licht pro Raum mit Schiebereglern und Szenen`,
          `Medien: Quellen, Transport, Lautstärke und Audiozonen`,
          `Sicherheit: Codetastatur, Schlösser, Kameras`,
        ],
      },
    },
  },
  {
    id: `siege-nyon`,
    name: `Siège Lakeside Nyon`,
    status: `concept`,
    client: `Siège d'entreprise`,
    sectors: [`meeting`],
    devices: [`crestron`, `ios_tablet`, `ios_phone`],
    isInteractive: true,
    interactiveComponent: `siege-nyon`,
    thumbnailUrl: `https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=600&q=80`,
    year: `2026`,
    text: {
      fr: {
        description: `Siège d'entreprise à Nyon, thème « Atelier clair » : cartes blanches sur gris chaud, accent dégradé, tout le bâtiment lisible sur un seul écran.`,
        details: `Six salles de réunion pilotées depuis les dalles de couloir, l'iPad de la réception et le smartphone des collaborateurs. L'accueil réunit sur un seul écran l'heure et la météo, la réunion en cours ou à venir, le climat sur cadran dégradé, l'éclairage par scène, les stores et l'écran avec ses sources. La page Salles montre libre / occupée, la capacité et l'équipement, avec réservation rapide. Présentation gère les sources (PC, sans fil, Teams, Apple TV), le volume et les scènes ; Visio pilote l'appel, le micro, la caméra PTZ et ses positions ; l'Agenda du jour se lit et se modifie sur place.`,
        features: [
          `Accueil tout-en-un : heure, réunion, climat, éclairage, stores, écran`,
          `Six salles avec statut libre / occupée et réservation rapide`,
          `Présentation : sources, volume, scènes d'éclairage, stores`,
          `Visioconférence : appel, micro, caméra PTZ et positions`,
          `Agenda du jour éditable sur l'écran`,
          `Police Outfit, cadran à dégradé bleu → rose`,
        ],
      },
      en: {
        description: `Corporate headquarters in Nyon, "Light studio" theme: white cards on warm grey, gradient accent, the whole building readable on one screen.`,
        details: `Six meeting rooms controlled from corridor panels, the reception iPad and employees' phones. The home screen brings together time and weather, the current or next meeting, climate on a gradient dial, lighting by scene, shades and the display with its sources. The Rooms page shows free / busy, capacity and equipment, with quick booking. Present handles sources (laptop, wireless, Teams, Apple TV), volume and scenes; Video call drives the call, mic, PTZ camera and presets; today's Agenda is read and edited on the spot.`,
        features: [
          `All-in-one home: time, meeting, climate, lighting, shades, display`,
          `Six rooms with free / busy status and quick booking`,
          `Present: sources, volume, lighting scenes, shades`,
          `Video call: call, mic, PTZ camera and presets`,
          `Today's agenda editable on screen`,
          `Outfit typeface, blue → pink gradient dial`,
        ],
      },
      de: {
        description: `Firmensitz in Nyon, Thema «Helles Atelier»: weisse Karten auf warmem Grau, Verlaufsakzent, das ganze Gebäude auf einem Bildschirm.`,
        details: `Sechs Sitzungszimmer, gesteuert über Flurpanels, das iPad am Empfang und die Smartphones der Mitarbeitenden. Der Startbildschirm vereint Uhrzeit und Wetter, die laufende oder nächste Besprechung, das Klima auf einer Verlaufsskala, Licht nach Szene, Storen und das Display mit seinen Quellen. Die Seite Räume zeigt frei / belegt, Kapazität und Ausstattung mit Schnellbuchung. Präsentation verwaltet Quellen (Laptop, kabellos, Teams, Apple TV), Lautstärke und Szenen; Videocall steuert Anruf, Mikrofon, PTZ-Kamera und Positionen; die Tagesagenda wird direkt bearbeitet.`,
        features: [
          `Alles-in-einem-Start: Uhrzeit, Besprechung, Klima, Licht, Storen, Display`,
          `Sechs Räume mit Status frei / belegt und Schnellbuchung`,
          `Präsentation: Quellen, Lautstärke, Lichtszenen, Storen`,
          `Videocall: Anruf, Mikrofon, PTZ-Kamera und Positionen`,
          `Tagesagenda am Bildschirm editierbar`,
          `Schrift Outfit, Verlaufsskala blau → rosa`,
        ],
      },
    },
  },
  {
    id: `appartement-carouge`,
    name: `Appartement Carouge`,
    status: `concept`,
    client: `Appartement familial`,
    sectors: [`residentiel`],
    devices: [`ios_phone`, `ios_tablet`, `crestron`, `android_phone`],
    isInteractive: true,
    interactiveComponent: `appartement-carouge`,
    thumbnailUrl: `https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=600&q=80`,
    year: `2026`,
    text: {
      fr: {
        description: `Appartement familial à Carouge, thème « Spectre » : fond anthracite et une couleur par système — médias cyan, éclairage ambre, climat ardoise, stores rose, accès violet.`,
        details: `Un appartement de famille où chacun retrouve un système à sa couleur avant même de lire : le cyan des médias, l'ambre de l'éclairage, l'ardoise du climat, le rose des stores, le violet de l'accès, le vert de la sécurité, l'indigo des routines. L'accueil est une mosaïque de tuiles larges avec leurs commandes directes (lecture, ± consigne, stores) et quatre pilules d'ambiance. Chaque page développe son système : sources et zones audio, sliders d'éclairage, climat par pièce, stores avec visuel de lamelles, interphone et serrures, routines familiales (Réveil, Devoirs, Dîner, Coucher, Film, Week-end) planifiables.`,
        features: [
          `Une couleur par système, lisible avant le texte`,
          `Accueil en tuiles larges avec commandes directes`,
          `Médias : sources, transport, volume, zones audio`,
          `Éclairage et climat pièce par pièce`,
          `Stores avec visuel de lamelles, interphone et serrures`,
          `Routines familiales planifiées et activables en un appui`,
        ],
      },
      en: {
        description: `Family apartment in Carouge, "Spectrum" theme: charcoal background and one colour per system — cyan media, amber lighting, slate climate, pink shades, purple access.`,
        details: `A family apartment where everyone finds a system by its colour before reading: cyan for media, amber for lighting, slate for climate, pink for shades, purple for access, green for security, indigo for routines. The home screen is a mosaic of wide tiles with direct controls (play, ± setpoint, shades) and four mood pills. Each page expands its system: sources and audio zones, lighting sliders, climate per room, shades with a slat visual, intercom and locks, family routines (Wake up, Homework, Dinner, Bedtime, Movie, Weekend) that can be scheduled.`,
        features: [
          `One colour per system, readable before the text`,
          `Wide-tile home screen with direct controls`,
          `Media: sources, transport, volume, audio zones`,
          `Lighting and climate room by room`,
          `Shades with slat visual, intercom and locks`,
          `Scheduled family routines, one tap to run`,
        ],
      },
      de: {
        description: `Familienwohnung in Carouge, Thema «Spektrum»: anthrazitfarbener Hintergrund und eine Farbe pro System — Medien cyan, Licht bernstein, Klima schiefer, Storen rosa, Zugang violett.`,
        details: `Eine Familienwohnung, in der jedes System an seiner Farbe erkannt wird, noch bevor man liest: Cyan für Medien, Bernstein für Licht, Schiefer für Klima, Rosa für Storen, Violett für Zugang, Grün für Sicherheit, Indigo für Routinen. Der Startbildschirm ist ein Mosaik breiter Kacheln mit direkten Bedienelementen (Wiedergabe, ± Sollwert, Storen) und vier Stimmungs-Pillen. Jede Seite entfaltet ihr System: Quellen und Audiozonen, Lichtregler, Klima pro Raum, Storen mit Lamellengrafik, Gegensprechanlage und Schlösser, planbare Familienroutinen (Aufstehen, Hausaufgaben, Abendessen, Schlafenszeit, Film, Wochenende).`,
        features: [
          `Eine Farbe pro System, erkennbar vor dem Text`,
          `Startbildschirm mit breiten Kacheln und direkter Bedienung`,
          `Medien: Quellen, Transport, Lautstärke, Audiozonen`,
          `Licht und Klima Raum für Raum`,
          `Storen mit Lamellengrafik, Gegensprechanlage und Schlösser`,
          `Geplante Familienroutinen, per Tipp aktivierbar`,
        ],
      },
    },
  },
