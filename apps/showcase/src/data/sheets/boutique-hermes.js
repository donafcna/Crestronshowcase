...
export default {
  "fr": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "image": "/sheets/boutique-hermes/06-background.png",
        "buttons": []
      },
      {
        ...
        "image": "/sheets/boutique-hermes/07-panel.png",
        "buttons": []
      }
    ]
  },
  "en": {
    "intro": "Two-level concept boutique with an entrance hall, grand staircase and 14 salons. Space selection and lighting controls are synchronised with the 3D model. Touch interface for wall panel, iPad and iPhone; simulated controls without a connected physical installation. The TSW panel presents levels and spaces in HTML/CSS, without loading the 3D model. Cards display the average lighting circuit level for each space; scenes, music and ambience remain available. 3D accompanies the Smartphone showcase and remains available on tablets.",
    "sections": [
      {
  ...
  "de": {
    "intro": "Boutiquenkonzept auf zwei Ebenen mit Eingangshalle, repräsentativer Treppe und 14 Salons. Raumauswahl und Lichtsteuerung sind mit dem 3D-Modell synchronisiert. Touch-Oberfläche für Wandpanel, iPad und iPhone; simulierte Steuerung ohne angeschlossene Anlage. Das TSW-Panel zeigt Ebenen und Räume mit HTML/CSS, ohne das 3D-Modell zu laden. Die Karten zeigen den Mittelwert der Lichtkreise je Raum; Szenen, Musik und Ambiente bleiben bedienbar. Die 3D-Ansicht begleitet den Smartphone-Showcase und bleibt auf Tablets verfügbar.",
    "sections": [
      {
