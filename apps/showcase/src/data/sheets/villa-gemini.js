    ...
    sections: [
      {
        ...
        buttons: [
          ...
          ["🔊 + curseur 65 %", "Volume de la zone audio ; le pourcentage affiché suit le curseur."],
    ...
    sections: [
      {
        ...
        buttons: [
          ...
          ["🔊 + 65 % slider", "Audio zone volume; the displayed percentage follows the slider."],
    ...
    sections: [
      {
        ...
        buttons: [
          ...
          ["🔊 + Regler 65 %", "Lautstärke der Audiozone; die Prozentanzeige folgt dem Regler."],
