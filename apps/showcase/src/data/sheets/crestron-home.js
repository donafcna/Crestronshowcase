...
export default {
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        buttons: [["Volume vidéo · ⏻", "Règle le volume de l’écran sélectionné de 0 à 100 et éteint uniquement cet écran. Le volume est conservé séparément pour chaque écran."],
          ...
          ["TV / IPTV · Apple TV · Lecteur Blu-ray · PC / Présentation · Vidéosurveillance", "Route la source vers l'écran ciblé (et l'allume) ; une coche violette marque la source active."],
  ...
  en: {
    ...
    sections: [
      ...
      { title: "Video sheet", image: IMG + "09-feuille-video.png", text: "Video distribution: four displays of the house, five sources, and the channel grid when the TV source is selected.", buttons: [["Video volume · ⏻", "Adjusts the selected display volume from 0 to 100 and switches off that display only. Each display keeps its own volume."], ["Displays (list)", "Selects the display to control; the purple row is the targeted display, the subtitle shows the source or “Inactive”."], ["⏻ (per display)", "Turns the display on to TV / IPTV or off."], ["TV / IPTV · Apple TV · Lecteur Blu-ray · PC / Présentation · Vidéosurveillance", "Routes the source to the targeted display (and turns it on); a purple tick marks the active source."], ["Channels RTS 1 … Musique (201–208)", "Channel shortcuts, shown only on TV / IPTV; the active channel is outlined in purple."]] },
  ...
  de: {
    ...
    sections: [
      ...
      { title: "Blatt Video", image: IMG + "09-feuille-video.png", text: "Videoverteilung: vier Displays des Hauses, fünf Quellen und das Senderraster, wenn die TV-Quelle gewählt ist.", buttons: [["Video-Lautstärke · ⏻", "Regelt die Lautstärke des gewählten Displays von 0 bis 100 und schaltet nur dieses Display aus. Jedes Display behält seine eigene Lautstärke."], ["Displays (Liste)", "Wählt das zu steuernde Display; die violette Zeile ist das Zieldisplay, der Untertitel zeigt die Quelle oder „Inaktiv“."], ["⏻ (pro Display)", "Schaltet das Display auf TV / IPTV ein oder aus."], ["TV / IPTV · Apple TV · Lecteur Blu-ray · PC / Présentation · Vidéosurveillance", "Leitet die Quelle auf das Zieldisplay (und schaltet es ein); ein violettes Häkchen markiert die aktive Quelle."], ["Sender RTS 1 … Musique (201–208)", "Senderkurzwahl, nur bei TV / IPTV sichtbar; der aktive Sender ist violett umrandet."]] },
