...
export function HotelBrassusBackground({stageRef,guiFrameRef}) {
 ...
 useEffect(()=>{
  ...
  // Même convention que Villa Crans : molette vers le bas = vue générale,
  // molette vers le haut = rapprochements successifs vers la dernière zone.
  const wheel=createWheelNavigation(delta=>send({zoom:delta}),{
